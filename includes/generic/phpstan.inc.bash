...
do
    set -x
    phpNoXdebug -f bin/phpstan  -- analyse $pathsStringArray -l7 -c "$phpstanConfigPath"
    phpStanExitCode=$?
    set +x
    ...
    then
        ...
        phpNoXdebug -f bin/phpstan  -- analyse $pathsStringArray -l7 -c "$phpstanConfigPath" --debug
        exit 1
    fi
